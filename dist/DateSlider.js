...
var DateSlider = /** @class */ (function (_super) {
    ...
    DateSlider.prototype.render = function () {
        var _this = this;
        var playStopButton = react_1["default"].createElement("div", null,
            react_1["default"].createElement(semantic_ui_react_1.Button, { onClick: function () { return _this.clickStopPlayButton(); } }, this.state.isPlaying ? "Stop" : "Play"),
            "Speed: ",
            react_1["default"].createElement(semantic_ui_react_1.Select, { options: DateSlider.speedOptions(), value: this.state.playSpeed, onChange: this.changeSpeed }));
        // https://react-component.github.io/slider/examples/slider.html
        return (react_1["default"].createElement("div", { style: { width: 500 }, className: "centerFixedWidth" },
            react_1["default"].createElement(rc_slider_1["default"], { min: 0, max: this.dateRangeToSliderIndex(this.props.endTickDateRange), step: 1, value: this.dateRangeToSliderIndex(this.props.currentTickDateRange), onChange: this.onSliderChange }),
